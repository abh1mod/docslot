...
const DocCard=({events})=>{
    ...
    const{name,specialization,phone,image}=events
    return <>
        <div className="bg-white rounded-xl shadow-md flex max-w-md overflow-hidden cursor-pointer hover:shadow-xl transition ">
  <div className="flex-shrink-0">
    <img className="h-48 w-48 object-cover rounded-full"  src={image || "https://png.pngtree.com/png-clipart/20241112/original/pngtree-smiling-cartoon-doctor-with-stethoscope-clipart-png-image_16976469.png"} alt="Dr. John Smith" />
  </div>
